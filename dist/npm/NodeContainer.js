...
var _textStroke = require("./parsing/textStroke");
...
function () {
  function NodeContainer(node, parent, resourceLoader, index) {
    ...
    this.style = {
      ...
      paintOrder: (0, _paintOrder.parsePaintOrder)(style.paintOrder),
      position: position,
      textDecoration: (0, _textDecoration.parseTextDecoration)(style),
      textShadow: (0, _textShadow.parseTextShadow)(style.textShadow),
      textStroke: (0, _textStroke.parseTextStroke)(style.webkitTextStrokeWidth, style.webkitTextStrokeColor),
